...
contract RaffleTest is StdCheats, Test {
    ...
    function testCheckRaffleReturnsFalseIfRaffleNotOpen() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
    ...
    function testPerformUpkeepAndOnlyRunIfOnlyCheckUpkeepIsTrue() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
    ...
    function testPerformUpkeepUpDatesRaffleStataeAndEmitsRequestId()
        public
